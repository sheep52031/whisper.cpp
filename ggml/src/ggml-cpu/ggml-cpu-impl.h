...
// __SSE3__ and __SSSE3__ are not defined in MSVC, but SSE3/SSSE3 are present
// when AVX/AVX2/AVX512 are available
#if defined(_MSC_VER) &&                                                       \
...
#include <intrin.h>
#elif defined(__AVX__) || defined(__AVX2__) || defined(__AVX512F__) ||         \
    defined(__SSSE3__) || defined(__SSE3__) || defined(__SSE__)
#include <immintrin.h>
#endif
